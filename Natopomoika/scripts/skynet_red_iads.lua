...
-- Red Hama IADS
red_hama_iads = SkynetIADS:create('red_hama')
red_hama_iads:addEarlyWarningRadarsByPrefix('EW_RED_HAMA')
red_hama_iads:addSAMSitesByPrefix('SAM_RED_HAMA')
red_hama_iads:addRadioMenu()
red_hama_iads:activate()	
...
---debug settings remove from here on if you do not wan't any output on what the IADS is doing by default
local iadsDebug = red_hama_iads:getDebugSettings()
iadsDebug.IADSStatus = true
iadsDebug.radarWentDark = true
iadsDebug.contacts = true
iadsDebug.radarWentLive = true
